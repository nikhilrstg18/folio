...
export const skillsData = [
  {
    ...
    items: [
      ...
      {
        altName: 'React | Redux | GraphQL | NextJS',
        iconClass: '',
        logo: 'reactreduxgqlnext.png',
        percent: '60',
        color: '#61dafb',
        itemId: nanoid(),
      },
      {
        altName: 'Bootstrap | Tailwind | Clarity Design | Material UI',
        iconClass: '',
        logo: 'cssfx.png',
        percent: '75',
        color: '#61dafb',
  ...
  },
  {
    ...
    items: [
      {
        altName: 'C# | .Net | Blazor',
        iconClass: '',
        logo: 'dotnetcsharp.png',
        percent: '70',
        color: '#0b9e0b',
        itemId: nanoid(),
      },
      {
        altName: 'NodeJS | GraphQL | Express',
        iconClass: '',
        logo: 'nodejsexpressgql.png',
        percent: '50',
        color: '#83cd29',
        itemId: nanoid(),
      },
      {
        altName: 'Java | SpringBoot | Swagger',
        iconClass: '',
        logo: 'javaspring.png',
        percent: '60',
        color: '#2f74c0',
      ...
      {
        altName: 'MS SQL Server | PostgreSQL | MongoDB',
        iconClass: '',
        logo: 'databases.png',
        percent: '50',
        color: '#2f74c0',
      ...
      {
        altName: 'Hibernate | Dapper | EF Core',
        iconClass: '',
        logo: 'orm.png',
        percent: '50',
        color: '#2f74c0',
  ...
  },
  {
    ...
    items: [
      ...
      {
        altName: 'VS 2022 | VS Code | Azure Devops | MS Teams ',
        iconClass: '',
        logo: 'tools.png',
        percent: '70',
        color: '#61dafb',
